...
#define GPIOA_BSR	*((u32*)(GPIOA_BASE_ADRESS + 0x10))
#define GPIOA_BRR	*((u32*)(GPIOA_BASE_ADRESS + 0x14))
#define GPIOA_LCK	*((u32*)(GPIOA_BASE_ADRESS + 0x18))
...
#define GPIOB_BSR	*((u32*)(GPIOB_BASE_ADRESS + 0x10))
#define GPIOB_BRR	*((u32*)(GPIOB_BASE_ADRESS + 0x14))
#define GPIOB_LCK	*((u32*)(GPIOB_BASE_ADRESS + 0x18))
...
#define GPIOC_BSR	*((u32*)(GPIOC_BASE_ADRESS + 0x10))
#define GPIOC_BRR	*((u32*)(GPIOC_BASE_ADRESS + 0x14))
#define GPIOC_LCK	*((u32*)(GPIOC_BASE_ADRESS + 0x18))
